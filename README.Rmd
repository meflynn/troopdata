...
cat(
	...
	badge_devel("meflynn/troopdata", "green"),
...
`get_exercises()`: Returns a long format data frame containing data on military exercises. These data were originally compiled by Vito D'Orazio and Kevin Galambos.
