...
- **Michael Flynn**. Author, maintainer.
  [](https://orcid.org/0000-0002-6064-740X)

## Citation

Source:
[`DESCRIPTION`](https://github.com/meflynn/troopdata/blob/master/DESCRIPTION)

Flynn M (2026). *troopdata: Tools for Analyzing Cross-National Military
Deployment and Basing Data*. R package version 1.0.4,
